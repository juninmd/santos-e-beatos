---
title: São João Damasceno
description: Biografia, milagres, curiosidades e mapa de São João Damasceno.
---

# São João Damasceno

![São João Damasceno](imagens/portrait.jpg)

> "O que um livro é para os que sabem ler, uma imagem é para os que não sabem."

- **Nascimento:** 675, Damasco, Síria
- **Morte:** 4 de dezembro de 749, Mosteiro de São Sabas, Palestina
- **Canonização:** Venerado desde os primeiros séculos
...
<MiracleMap :items='[
  { lat: 33.5138, lng: 36.2765, type: "nascimento", title: "O Milagre da Mão Cortada", description: "Segundo a tradição, a mão direita de João, cortada por ordem do califa devido a uma falsa acusação, foi milagrosamente reimplantada após suas preces diante de um ícone da Virgem Maria. Local de nascimento (675)." },
  { lat: 31.705, lng: 35.33, type: "morte", title: "Mosteiro de São Sabas, Palestina", description: "Local da morte (4 de dezembro de 749)." }
]' />
